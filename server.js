...
Analyse this contract and return ONLY a valid JSON object (no markdown, no explanation):
{
  ...
  "fees": "free-text description of contract value — include currency and payment structure, e.g. 'SGD 5,000/month', 'CNY 120,000 total', 'SGD 3,000 per headcount placed', 'TWD 50,000 one-off'. Return null if no value is stated.",
